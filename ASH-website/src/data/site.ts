...
export const NAV = [
  ...
  { label: 'In Prod', to: '/in-prod', index: '03', img: '/img/ash-night.jpg' },
  { label: 'Off Clock', to: '/off-clock', index: '04', img: '/img/ash-walk.jpg' },
  { label: 'Contact', to: '/contact', index: '05', img: '/img/anon-void.jpg' },
] as const
...
export const SHOTS = [
  ...
  {
    src: '/img/ash-desk.png',
    caption: 'The bench — green on green',
    col: '7 / span 6',
    ar: '4 / 3',
    speed: -0.12,
  },
